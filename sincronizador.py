...
#  Descarga desde ESPN
# -----------------------------------------------------------------------------
# La peticion va SIN cabeceras a proposito: ESPN responde 403 a los clientes que
# se hacen pasar por un navegador cuando la peticion sale de un datacenter, que
# es justo desde donde corre este cron. El detalle y las mediciones estan en
# `cargar_calendario.py`. NO AGREGAR UN User-Agent AQUI.
